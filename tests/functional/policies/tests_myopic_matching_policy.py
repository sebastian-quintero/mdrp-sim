...
class TestsMyopicMatchingPolicy(unittest.TestCase):
    ...
    def test_generate_routes_idle_couriers(self, osrm):
        ...
        routes = MyopicMatchingPolicy._generate_routes(
    ...
    def test_generate_matching_prospects_all(self, osrm):
        ...
        prospects = MyopicMatchingPolicy._generate_matching_prospects(
            routes=routes,
            couriers=[courier_1, courier_2],
            env_time=env_time
        )
    ...
    def test_myopic_matching_policy_execute(self, osrm):
        ...
        costs = MyopicMatchingPolicy._generate_matching_costs(
            routes=routes,
            couriers=[courier_1, courier_2, courier_3],
            prospects=prospects,
            env_time=env_time
        ...
        notifications = MyopicMatchingPolicy._process_solution(solution, problem)
